...
class _FoodScreenState extends State<FoodScreen> {
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const FaIcon(FontAwesomeIcons.mugSaucer, color: Colors.white, size: 20),
              const SizedBox(width: 8),
              const Text('Comida', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
              const Spacer(),
              if (isAdmin)
                IconButton(
  ...
  Widget _buildCategoryFilters() {
    final categories = {
      'bebidas': FontAwesomeIcons.wineGlass,
      'frituras': FontAwesomeIcons.cookie,
      'botanas': FontAwesomeIcons.pepperHot,
      'energizantes': FontAwesomeIcons.bolt,
    };
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return const Center(child: Text('No hay productos. ¡Añade uno con el botón +!'));
        }
